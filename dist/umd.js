(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.oradom = {}));
    ...
    class VNode {
        ...
        appendTo(obj, direction = "append") {
            ...
            if (direction === "append") {
                obj.append(new VNodeUtilExtend().extractEl(this.element));
            }
            else {
                obj.prepend(new VNodeUtilExtend().extractEl(this.element));
            }
            return this;
        }
        getBounds() {
    ...
    VNode.Util = new VNodeUtilExtend;
    ...
    class P_VNodeUtil {
        ...
        static injectItems(vnode, direction = "append", objs) {
            ...
            for (const item of objs) {
                ...
                const extracted = typeof item === "string"
                    ? item
                    : VNodeUtilExtend.extractEl(item);
                if (direction === "append") {
